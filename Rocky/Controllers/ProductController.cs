...
namespace Rocky.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            {
                obj.Category = _db.Category.FirstOrDefault(u => u.Id == obj.CategoryId); //what is this syntex what does it do.
        ...
        {
            //what is selectlistItem
            /* IEnumerable<SelectListItem> CategoryDropDown = _db.Category.Select(i => new SelectListItem
             {
                 Text = i.Name,
                 Value = i.Id.ToString()
             });*/
            //what is select in db.

            //what extely does this view bag do..
            ...
            if (id == null)
            {
                //it will just create a new product
